...
router.get('/weekly/:stock_name',async (req,res)=>{
    try{
        await request(`https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY&symbol=${req.params.stock_name}&apikey=${apiKey}`, (err,response, body) => {
...
router.get('/weekly-adjusted/:stock_name',async (req,res)=>{
    try{
        await request(`https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY_ADJUSTED&symbol=${req.params.stock_name}&apikey=${apiKey}`, (err,response, body) => {
            console.log('error: ',err)
            console.log('statusCode:',response && response.statusCode);
            console.log('body:', body)
...
router.get('/monthly/:stock_name',async (req,res)=>{
    try{
        await request(`https://www.alphavantage.co/query?function=TIME_SERIES_MONTHLY&symbol=${req.params.stock_name}&apikey=${apiKey}`, (err,response, body) => {
            console.log('error: ',err)
            console.log('statusCode:',response && response.statusCode);
            console.log('body:', body)
...
router.get('/monthly-adjusted/:stock_name',async (req,res)=>{
    try{
        await request(`https://www.alphavantage.co/query?function=TIME_SERIES_MONTHLY_ADJUSTED&symbol=${req.params.stock_name}&apikey=${apiKey}`, (err,response, body) => {
            console.log('error: ',err)
            console.log('statusCode:',response && response.statusCode);
            console.log('body:', body)
...
router.get('/daily/:stock_name',async (req,res)=>{
    try{
        await request(`https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=${req.params.stock_name}&apikey=${apiKey}`, (err,response, body) => {
            console.log('error: ',err)
            console.log('statusCode:',response && response.statusCode);
            console.log('body:', body)
